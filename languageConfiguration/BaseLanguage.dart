...
class BaseLanguage {
  ...
  String get cash => getContentValueFromKey(617);
  ...
  String get notes => getContentValueFromKey(174);
  ...
  String get paymentType => getContentValueFromKey(179);

  String get paymentStatus => getContentValueFromKey(180);

  String get vehicle => getContentValueFromKey(184);

  String get vehicleName => getContentValueFromKey(185);

  String get aboutDeliveryMan => getContentValueFromKey(186);

  String get aboutUser => getContentValueFromKey(187);

  String get returnReason => getContentValueFromKey(188);

  String get cancelledReason => getContentValueFromKey(189);
  ...
  String get onPickup => getContentValueFromKey(194);

  String get onDelivery => getContentValueFromKey(195);

  String get stripe => getContentValueFromKey(196);

  String get razorpay => getContentValueFromKey(197);

  String get payStack => getContentValueFromKey(198);

  String get flutterWave => getContentValueFromKey(199);
  ...
  String get price => getContentValueFromKey(188);
  ...
  String get viewMore => getContentValueFromKey(183);
  ...
  String get bidPlacedSuccessfully => getContentValueFromKey(592);
  ...
  String get all => getContentValueFromKey(612);
  String get amountRange => getContentValueFromKey(613);
  String get minAmount => getContentValueFromKey(614);
