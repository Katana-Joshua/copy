...
class CreateOrderScreenState extends State<CreateOrderScreen> {
  ...
  void createOrderApiCall([String status = ORDER_CREATED]) async {
    ...
    Map<String, dynamic> req = {
      ...
      "total_distance": totalDistance,
      "total_amount": double.parse(customPriceController.text.isEmpty
          ? "0"
      ...
      "discount_amount": 0.0,
      "coupon_code": selectedCoupon?.couponCode,
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(language.customPrice, style: boldTextStyle()),
                8.height,
                AppTextField(
                  ...
                  decoration:
                      inputDecoration(context, label: language.enterAmount),
                  onChanged: (value) {
                    if (value.isNotEmpty) {
                      totalAmountResponse?.totalAmount = double.parse(value);
                      setState(() {});
                    }
                  },
                ),
        ...
        children: [
          ...
          if (totalAmountResponse != null)
            OrderAmountDataWidget(
                ...
                diffWeight: 0.0,
                diffDistance: 0.0,
                totalAmount: double.parse(customPriceController.text.isEmpty
                    ? "0"
                    : customPriceController.text),
                weightAmount: 0.0,
                perWeightCharge: 0.0,
                perKmCityDataCharge: 0.0,
                coupon: selectedCoupon ?? null,
                isAppliedCoupon: isAppliedCoupon,
                perkmVehiclePrice: 0.0,
                baseTotal: double.parse(customPriceController.text.isEmpty
                    ? "0"
                    : customPriceController.text)),
