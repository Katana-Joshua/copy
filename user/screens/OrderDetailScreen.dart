...
class OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  TextEditingController bidNotesController = TextEditingController();
  bool showBidDialog = false;
  ...
  orderDetailApiCall() async {
    ...
    await getOrderDetails(widget.orderId).then((value) {
      ...
      if (orderData!.packagingSymbols != null) {
        packagingSymbols.clear();
        if (orderData!.packagingSymbols is List) {
          List<dynamic> symbols = orderData!.packagingSymbols as List;
          getPackagingSymbols().forEach((element1) {
            symbols.forEach((element2) {
        ...
        content: Column(
          ...
          children: [
            AppTextField(
              ...
              decoration: commonInputDecoration(hintText: language.bidAmount),
            ...
            AppTextField(
              ...
              decoration: commonInputDecoration(hintText: language.notes),
              maxLines: 3,
            ),
          ],
        ),
          ...
          TextButton(
            onPressed: () {
              if (bidAmountController.text.isNotEmpty) {
                ...
                toast(language.pleaseEnterBidAmount);
              }
            },
  ...
  Future<void> placeBid() async {
    ...
    try {
      Map<String, dynamic> req = {
        ...
        "bid_amount": double.parse(bidAmountController.text),
        "notes": bidNotesController.text,
      };

      await placeOrderBid(req);
      toast(language.bidPlacedSuccessfully);
      bidAmountController.clear();
      bidNotesController.clear();
    } catch (e) {
      toast(e.toString());
    } finally {
      appStore.setLoading(false);
      ...
      body: Stack(
        children: [
              ...
              ? Stack(
                  children: [
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (orderData!.extraCharges != null)
                                                  ...
                                                  children: List.generate(
                                                      (orderData!
                                                          ...
                                                          ? (orderData!
                                                              ...
                                                              .length
                                                          : 0, (index) {
                                                var extraCharge = (orderData!
                                                        .extraCharges is List)
                                                ...
                                                return Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      16.width,
                                                      Text(
                                                          '${printAmount(extraCharge['value'] ?? 0)}',
                                                          style:
                                                              primaryTextStyle()),
                                                    ],
                                                  ),
                                          ...
                                          ).visible((orderData!.extraCharges
                                                  is List) &&
                                              (orderData!.extraCharges as List)
                                                  .isNotEmpty),
                                        16.height,
                                        Row(
                                          mainAxisAlignment:
                    ...
                    Positioned(
                        ...
                        orderData!.status != ORDER_CANCELLED &&
                        userData!.userType.validate() != ADMIN),
                    // Accept Job button for delivery man
                    Positioned(
                      bottom: 10,
                      left: 16,
                      right: 16,
                      child: commonButton('Accept Job', () async {
                        appStore.setLoading(true);
                        await updateOrder(
                    ...
                    ).visible(orderData!.status == ORDER_CREATED &&
                        getStringAsync(USER_TYPE) == DELIVERY_MAN),
                  ],
                )
              : SizedBox(),
          ...
          if (getStringAsync(USER_TYPE) == DELIVERY_MAN &&
              orderData != null &&
              orderData!.bid_type == 1 &&
              orderData!.status == ORDER_CREATED)
            Positioned(
              bottom: 10,
              left: 14,
              right: 14,
              child: commonButton(language.placeBid, () {
                showBidForm();
              }, width: context.width()),
            ),
        ],
